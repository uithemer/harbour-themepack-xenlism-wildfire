...
[![GitHub license](https://img.shields.io/github/license/fravaccaro/harbour-themepack-xenlism-wildfire.svg)](https://github.com/fravaccaro/harbour-themepack-xenlism-wildfire/blob/master/LICENSE) [![GitHub issues](https://img.shields.io/github/issues/fravaccaro/harbour-themepack-xenlism-wildfire.svg)](https://github.com/fravaccaro/harbour-themepack-xenlism-wildfire/issues) [![GitHub releases](https://img.shields.io/github/release/fravaccaro/harbour-themepack-xenlism-wildfire.svg)](https://github.com/fravaccaro/harbour-themepack-xenlism-wildfire/releases/latest) [![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/fravaccaro)

## Request a new icon

You can request a new icon via the theme companion app or by [opening an issue](https://github.com/fravaccaro/harbour-themepack-xenlism-wildfire/issues).
